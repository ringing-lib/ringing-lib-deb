...
libringing-dev_0.4.0-2_amd64.deb:
	...
	fakeroot dpkg-deb --build src libringing-dev_0.4.0-2_amd64.deb

check: libringing-dev_0.4.0-2_amd64.deb
	lintian libringing-dev_0.4.0-2_amd64.deb

clean:
	rm -f libringing-dev_0.4.0-2_amd64.deb
